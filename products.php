    ...
    <header>
      ...
      <section class="products-container">
       ...
       <div class="shop-content">
        <!-- Generate Box Products with php -->
       <?php  
            ...
            while($row=mysqli_fetch_assoc($result_query)){
              ...
              echo "
                  <div class='product-box'>
                    <img src= './Img/$product_img' class='product-img'>
                    <h2 class='product-title'>$product_title</h2>
                    <span class='price'>$product_price zł</span>
                    <i class='bx bx-shopping-bag add-cart' data-title='$product_title' data-price='$product_price' data-img='$product_img' data-id='$product_id'></i>
                    </div>";
            }
        ?>
       </div>
